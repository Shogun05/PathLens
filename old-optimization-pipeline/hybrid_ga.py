...
class HybridGAConfig:
    ...
    random_seed: int = 42
    analysis_dir: Path = Path("../data/optimization/runs")
    # progress options
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--per-pool-limit", type=int, default=500)
    parser.add_argument("--analysis-dir", type=Path, default=project_root / "optimization-pipeline" / "runs")
