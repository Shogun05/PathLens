...
def show_cache_status(project_dir: Path):
    ...
    sections = [
        ("Raw OSM Data", [
            ("Street network", data_dir / "raw" / "osm" / "graph.graphml"),
            ("Buildings", data_dir / "raw" / "osm" / "buildings.geojson"),
            ("Land use", data_dir / "raw" / "osm" / "landuse.geojson"),
            ("Transit", data_dir / "raw" / "osm" / "transit.geojson"),
            ("POIs (converted)", data_dir / "raw" / "osm" / "pois.geojson"),
            ("Nodes", data_dir / "raw" / "osm" / "nodes.parquet"),
            ("Edges", data_dir / "raw" / "osm" / "edges.parquet"),
        ]),
        ("Processed Data", [
        ...
        ("Visualizations", [
            ("Interactive map", project_dir / "interactive_map.html"),
        ]),
        ("Amenity Cache", [
            ("JSON files", scripts_dir / "bengaluru_amenities"),
            ("Area list", scripts_dir / "bengaluru_areas_list.json"),
        ]),
        ("Nominatim Cache", [
            ("Geocoding cache", data_dir / "cache" / "nominatim"),
        ]),
    ]
...
def clear_cache(project_dir: Path, cache_type: str):
    ...
    cache_maps = {
        "raw": [
            data_dir / "raw" / "osm" / "graph.graphml",
            data_dir / "raw" / "osm" / "buildings.geojson",
            data_dir / "raw" / "osm" / "landuse.geojson",
            data_dir / "raw" / "osm" / "transit.geojson",
            data_dir / "raw" / "osm" / "nodes.parquet",
            data_dir / "raw" / "osm" / "edges.parquet",
        ],
        "pois": [
            data_dir / "raw" / "osm" / "pois.geojson",
        ],
        "processed": [
        ...
        "viz": [
            project_dir / "interactive_map.html",
        ],
        "amenities": [
            scripts_dir / "bengaluru_amenities",
            scripts_dir / "bengaluru_areas_list.json",
        ],
        "scoring_cache": [
            data_dir / "cache" / "scoring",
        ],
