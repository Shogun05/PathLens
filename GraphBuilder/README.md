...
Please find the dataset split, the pre-processed dataset and the sat2graph outputs from this [link](https://drive.google.com/drive/folders/1uABt127ehNBQyfCnv6OND841ZrUlhmNB?usp=sharing).
