...
NODES_CSV = BASE_DIR / "data" / "analysis" / "optimized_nodes_with_scores.csv"
FEAS_CSV = BASE_DIR / "data" / "landuse" / "pathlens_feasibility_single_amenity.csv"
PLACEMENTS_GEOJSON = BASE_DIR / "data" / "landuse" / "pathlens_placements_single_amenity.geojson"
